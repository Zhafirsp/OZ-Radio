...
const PP_Terms = () => {
  ...
  return (
    ...
    <Container fluid className="col-md-8">
      <div>
        <h4 style={{ marginTop:"150px" }} className="fw-bold">Privacy Policy and Terms of Use</h4>
          <p><a href="#Terms" className="text-primary">(Click here for Terms of Use)</a></p>
          <p>Our Privacy Policy and Terms of Use apply to all users of KEXP’s digital platforms, including this website, embeddable content that we may make available for use on other people’s websites or digital platforms, and our apps (but not including third party content, discussed in Other Sites and Services, below.)</p>
          ...
          <div>
                ...
                <h4 id="Contacting"><u><i>Contacting Us</i></u></h4>
                  <p>If you have additional questions about how your personal information may be used, or if you have questions or comments about this Privacy Policy, please contact privacy@kexp.org. Or you can send mail to: KEXP, 472 1st Ave N, Seattle WA 98109.</p>
                </div>
                <div>
                <h4 id="DataProtection"><u><i>Data Protection under GDPR</i></u></h4>
                  <p>European Union citizens and individuals residing in the EU are entitled to additional protections under the General Data Protection Regulation (“GDPR”). The circumstances under which KEXP has lawful basis for processing the personal data of an individual who is subject to GDPR protections will vary, but may include contractual necessity, compliance with legal obligations, public interest, or the legitimate business interests of KEXP, provided that such interest is not overridden by the rights or freedoms of the individual. Where no such lawful basis may exist for processing personal data, KEXP must obtain affirmative consent before any processing may occur.</p>
                  ...
                  <ul>
                      <li>To request a copy of your personal data which KEXP holds;</li>
                      <li>To request that KEXP provide you access to and/or rectify personal data that is inaccurate or out of date;</li>
                      <li>To request erasure of your personal data where it is no longer necessary for KEXP to retain it;</li>
                      <li>If you have consented to processing, the right to withdraw consent at any time;</li>
                      <li>To request that the data controller provide you with your personal data and where possible, to transmit that data directly to another data controller, where applicable. This right of portability only applies where the processing is based on consent or is necessary for the performance of a contract and if KEXP processes the data by automated means;</li>
                  ...
                  <p>You may exercise these rights by contacting KEXP at privacy@kexp.org and stating your specific request in writing. KEXP reserves the right to verify your identity and confirm your right to the information. The following options are also available:</p>
                  <ul>
                      <li>To withdraw consent for collection of precise device location, you may access the privacy settings of your mobile device and/or the settings of the KEXP mobile application.</li>
